...
Flipping is a common building block for many functions. Consider as an
example the implementation of the mapping functions:
...
following observational equalities hold:
